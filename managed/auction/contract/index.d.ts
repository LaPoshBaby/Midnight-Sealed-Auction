...
export type Witnesses<PS> = {
  my_bid(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, bigint];
  my_public_key(context: __compactRuntime.WitnessContext<Ledger, PS>): [PS, bigint];
}
...
export type Ledger = {
  ...
  readonly highest_bidder: bigint;
